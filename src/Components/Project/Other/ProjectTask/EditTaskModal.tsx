                  ...
                  onClick={() => {
                    setNewTask({
                      ...
                      ProjectTaskMembers: [
                        ...
                        {
                          StafferId: member.StafferId,
                          StafferFullName: member.StafferFullName,
                          StafferEmail: member.StafferEmail,
                          StafferImageUrl: member.StafferImageUrl,
                        },
                      ],
                    });
                  ...
                  onClick={() => {
                    setNewTask({
                      ...
                      ProjectTaskTags: [
                        ...
                        {
                          ProjectTaskTagId: tag.ProjectTaskTagId,
                          ProjectTaskTagName: tag.ProjectTaskTagName,
                          ProjectTaskTagColor: tag.ProjectTaskTagColor,
                        },
                      ],
                    });
                    addTaskTag(tag);
